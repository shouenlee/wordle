...
export const WORD_BANK = [
  ...
  'ALARM', 'ALBUM', 'ALERT', 'ALIKE', 'ALIVE', 'ALLOW', 'ALONE', 'ALONG', 'ALPHA', 'ALTER',
  'AMONG', 'ANGER', 'ANGLE', 'ANGRY', 'APART', 'APPLE', 'APPLY', 'ARENA', 'ARGUE', 'ARISE',
  'ARRAY', 'ASIDE', 'ASSET', 'AUDIO', 'AUDIT', 'AVOID', 'AWARD', 'AWARE', 'BADLY', 'BAKER',
  'BASES', 'BASIC', 'BASIS', 'BEACH', 'BEGIN', 'BEGUN', 'BEING', 'BELOW', 'BENCH', 'BIRTH',
  'BLACK', 'BLAME', 'BLIND', 'BLOCK', 'BLOOD', 'BOARD', 'BRAIN', 'BRAND', 'BREAD', 'BREAK',
  'BREED', 'BRIEF', 'BRING', 'BROAD', 'BUILD', 'BUILT', 'BUYER', 'CABLE', 'CARRY', 'CATCH',
  'CAUSE', 'CHAIN', 'CHAIR', 'CHART', 'CHASE', 'CHEAP', 'CHECK', 'CHEST', 'CHIEF', 'CHILD',
  'CIVIL', 'CLAIM', 'CLASS', 'CLEAN', 'CLEAR', 'CLIMB', 'CLOCK', 'CLOSE', 'COAST', 'COUNT',
  'COURT', 'COVER', 'CRAFT', 'CRASH', 'CREAM', 'CRIME', 'CROSS', 'CROWD', 'CROWN', 'CURVE',
  'CYCLE', 'DAILY', 'DANCE', 'DEATH', 'DEPTH', 'DOUBT', 'DRAFT', 'DRAMA', 'DREAM', 'DRESS',
  'DRINK', 'DRIVE', 'EARLY', 'EARTH', 'EMPTY', 'ENEMY', 'ENJOY', 'ENTER', 'ENTRY', 'EQUAL',
  'ERROR', 'EVENT', 'EXACT', 'EXIST', 'EXTRA', 'FAITH', 'FALSE', 'FATAL', 'FAULT', 'FIBER',
  'FIELD', 'FIFTH', 'FIGHT', 'FINAL', 'FOCUS', 'FORCE', 'FRAME', 'FRANK', 'FRESH', 'FRONT',
  'FRUIT', 'FULLY', 'FUNNY', 'GIANT', 'GRACE', 'GRADE', 'GRAND', 'GRASS', 'GREAT', 'GREEN',
  'GROSS', 'GROUP', 'GUARD', 'GUESS', 'GUEST', 'GUIDE', 'HAPPY', 'HEART', 'HEAVY', 'HENCE',
  'HORSE', 'HOTEL', 'HOUSE', 'HUMAN', 'IDEAL', 'IMAGE', 'INDEX', 'INNER', 'INPUT', 'ISSUE',
  'JOINT', 'JUDGE', 'KNIFE', 'LAUGH', 'LAYER', 'LEARN', 'LEASE', 'LEAST', 'LEAVE', 'LEGAL',
  'LEVEL', 'LIGHT', 'LIMIT', 'LOCAL', 'LOGIC', 'LUCKY', 'LUNCH', 'MAGIC', 'MAJOR', 'MARCH',
  'MATCH', 'METAL', 'MINOR', 'MONEY', 'MONTH', 'MORAL', 'MOTOR', 'MOUSE', 'MOUTH', 'MOVIE',
  'MUSIC', 'NEEDS', 'NOISE', 'NORTH', 'NOVEL', 'NURSE', 'OCCUR', 'OCEAN', 'OFFER', 'ORDER',
  'OTHER', 'OUTER', 'PANEL', 'PAPER', 'PARTY', 'PEACE', 'PHASE', 'PHONE', 'PHOTO', 'PIECE',
  ...
  'REFER', 'RIGHT', 'RIVAL', 'RIVER', 'ROUGH', 'ROUND', 'ROUTE', 'RURAL', 'SCALE', 'SCENE',
  'SCOPE', 'SCORE', 'SENSE', 'SERVE', 'SEVEN', 'SHADE', 'SHAKE', 'SHAPE', 'SHARE', 'SHARP',
  'SHEEP', 'SHEET', 'SHELF', 'SHELL', 'SHIFT', 'SHIRT', 'SHOCK', 'SHOOT', 'SHORT', 'SHOWN',
  ...
  'STILL', 'STOCK', 'STONE', 'STORE', 'STORM', 'STORY', 'STRIP', 'STUDY', 'STYLE', 'SUGAR',
  'SWEET', 'TABLE', 'TASTE', 'TEACH', 'TEETH', 'THANK', 'THEFT', 'THEIR', 'THEME', 'THERE',
  'THICK', 'THING', 'THINK', 'THIRD', 'THROW', 'TIGHT', 'TITLE', 'TODAY', 'TOUCH', 'TOUGH',
  'TOWER', 'TRACK', 'TRADE', 'TRAIN', 'TREAT', 'TREND', 'TRIAL', 'TRIBE', 'TRICK', 'TRIED',
  'TRUST', 'TRUTH', 'UNDER', 'UNITE', 'UNITY', 'UPSET', 'URBAN', 'USAGE', 'USUAL', 'VALID',
  'VALUE', 'VIDEO', 'VIRUS', 'VISIT', 'VITAL', 'VOICE', 'WASTE', 'WATCH', 'WATER', 'WHEEL',
  'WHERE', 'WHITE', 'WHOLE', 'WHOSE', 'WOMAN', 'WORLD', 'WORRY', 'WOULD', 'WOUND', 'WRITE',
  'WRONG', 'YIELD', 'YOUNG', 'YOUTH',

  // Adding even more common 5-letter words
  'ABIDE', 'ABOVE', 'ABUSE', 'ACUTE', 'ADMIT', 'ADOPT', 'ADULT', 'AFTER', 'AGAIN', 'AGENT',
  'AGREE', 'AHEAD', 'ALARM', 'ALBUM', 'ALERT', 'ALIKE', 'ALIVE', 'ALLOW', 'ALONE', 'ALONG',
  'ALPHA', 'ALTER', 'AMONG', 'ANGER', 'ANGLE', 'ANGRY', 'APART', 'APPLE', 'APPLY', 'ARENA',
  'ARGUE', 'ARISE', 'ARRAY', 'ASIDE', 'ASSET', 'AUDIO', 'AUDIT', 'AVOID', 'AWARD', 'AWARE',
  'BADLY', 'BAKER', 'BASES', 'BASIC', 'BASIS', 'BEACH', 'BEGIN', 'BEGUN', 'BEING', 'BELOW',
  'BENCH', 'BIRTH', 'BLACK', 'BLAME', 'BLIND', 'BLOCK', 'BLOOD', 'BOARD', 'BRAIN', 'BRAND',
  'BREAD', 'BREAK', 'BREED', 'BRIEF', 'BRING', 'BROAD', 'BUILD', 'BUILT', 'BUYER', 'CABLE',
  ...
  'CROWN', 'CURVE', 'CYCLE', 'DAILY', 'DANCE', 'DEATH', 'DEPTH', 'DOUBT', 'DRAFT', 'DRAMA',
  'DREAM', 'DRESS', 'DRINK', 'DRIVE', 'EARLY', 'EARTH', 'EMPTY', 'ENEMY', 'ENJOY', 'ENTER',
  'ENTRY', 'EQUAL', 'ERROR', 'EVENT', 'EXACT', 'EXIST', 'EXTRA', 'FAITH', 'FALSE', 'FATAL',
  'FAULT', 'FIBER', 'FIELD', 'FIFTH', 'FIGHT', 'FINAL', 'FOCUS', 'FORCE', 'FRAME', 'FRANK',
  'FRESH', 'FRONT', 'FRUIT', 'FULLY', 'FUNNY', 'GIANT', 'GRACE', 'GRADE', 'GRAND', 'GRASS',
  'GREAT', 'GREEN', 'GROSS', 'GROUP', 'GUARD', 'GUESS', 'GUEST', 'GUIDE', 'HAPPY', 'HEART',
  'HEAVY', 'HENCE', 'HORSE', 'HOTEL', 'HOUSE', 'HUMAN', 'IDEAL', 'IMAGE', 'INDEX', 'INNER',
  'INPUT', 'ISSUE', 'JOINT', 'JUDGE', 'KNIFE', 'LAUGH', 'LAYER', 'LEARN', 'LEASE', 'LEAST',
  'LEAVE', 'LEGAL', 'LEVEL', 'LIGHT', 'LIMIT', 'LOCAL', 'LOGIC', 'LUCKY', 'LUNCH', 'MAGIC',
  'MAJOR', 'MARCH', 'MATCH', 'METAL', 'MINOR', 'MONEY', 'MONTH', 'MORAL', 'MOTOR', 'MOUSE',
  'MOUTH', 'MOVIE', 'MUSIC', 'NEEDS', 'NOISE', 'NORTH', 'NOVEL', 'NURSE', 'OCCUR', 'OCEAN',
  'OFFER', 'ORDER', 'OTHER', 'OUTER', 'PANEL', 'PAPER', 'PARTY', 'PEACE', 'PHASE', 'PHONE',
  ...
  'REACH', 'READY', 'REFER', 'RIGHT', 'RIVAL', 'RIVER', 'ROUGH', 'ROUND', 'ROUTE', 'RURAL',
  'SCALE', 'SCENE', 'SCOPE', 'SCORE', 'SENSE', 'SERVE', 'SEVEN', 'SHADE', 'SHAKE', 'SHAPE',
  'SHARE', 'SHARP', 'SHEEP', 'SHEET', 'SHELF', 'SHELL', 'SHIFT', 'SHIRT', 'SHOCK', 'SHOOT',
  'SHORT', 'SHOWN', 'SIGHT', 'SINCE', 'SKILL', 'SLEEP', 'SLIDE', 'SMALL', 'SMART', 'SMILE',
  'SMOKE', 'SOLID', 'SOLVE', 'SORRY', 'SOUND', 'SOUTH', 'SPACE', 'SPARE', 'SPEAK', 'SPEED',
  'SPEND', 'SPENT', 'SPLIT', 'SPORT', 'STAFF', 'STAGE', 'STAND', 'START', 'STATE', 'STEAM',
  'STEEL', 'STICK', 'STILL', 'STOCK', 'STONE', 'STORE', 'STORM', 'STORY', 'STRIP', 'STUDY',
  'STYLE', 'SUGAR', 'SWEET', 'TABLE', 'TASTE', 'TEACH', 'TEETH', 'THANK', 'THEFT', 'THEIR',
  'THEME', 'THERE', 'THICK', 'THING', 'THINK', 'THIRD', 'THROW', 'TIGHT', 'TITLE', 'TODAY',
  'TOUCH', 'TOUGH', 'TOWER', 'TRACK', 'TRADE', 'TRAIN', 'TREAT', 'TREND', 'TRIAL', 'TRIBE',
  'TRICK', 'TRIED', 'TRUST', 'TRUTH', 'UNDER', 'UNITE', 'UNITY', 'UPSET', 'URBAN', 'USAGE',
  'USUAL', 'VALID', 'VALUE', 'VIDEO', 'VIRUS', 'VISIT', 'VITAL', 'VOICE', 'WASTE', 'WATCH',
  'WATER', 'WHEEL', 'WHERE', 'WHITE', 'WHOLE', 'WHOSE', 'WOMAN', 'WORLD', 'WORRY', 'WOULD',
  'WOUND', 'WRITE', 'WRONG', 'YIELD', 'YOUNG', 'YOUTH',

  // Adding even more words
  'ABATE', 'ABIDE', 'ABOVE', 'ABUSE', 'ACUTE', 'ADMIT', 'ADOPT', 'ADULT', 'AFTER', 'AGAIN',
  'AGENT', 'AGREE', 'AHEAD', 'ALARM', 'ALBUM', 'ALERT', 'ALIKE', 'ALIVE', 'ALLOW', 'ALONE',
  'ALONG', 'ALPHA', 'ALTER', 'AMONG', 'ANGER', 'ANGLE', 'ANGRY', 'APART', 'APPLE', 'APPLY',
  'ARENA', 'ARGUE', 'ARISE', 'ARRAY', 'ASIDE', 'ASSET', 'AUDIO', 'AUDIT', 'AVOID', 'AWARD',
  'AWARE', 'BADLY', 'BAKER', 'BASES', 'BASIC', 'BASIS', 'BEACH', 'BEGIN', 'BEGUN', 'BEING',
  'BELOW', 'BENCH', 'BIRTH', 'BLACK', 'BLAME', 'BLIND', 'BLOCK', 'BLOOD', 'BOARD', 'BRAIN',
  'BRAND', 'BREAD', 'BREAK', 'BREED', 'BRIEF', 'BRING', 'BROAD', 'BUILD', 'BUILT', 'BUYER',
  'CABLE', 'CARRY', 'CATCH', 'CAUSE', 'CHAIN', 'CHAIR', 'CHART', 'CHASE', 'CHEAP', 'CHECK',
  'CHEST', 'CHIEF', 'CHILD', 'CIVIL', 'CLAIM', 'CLASS', 'CLEAN', 'CLEAR', 'CLIMB', 'CLOCK',
  'CLOSE', 'COAST', 'COUNT', 'COURT', 'COVER', 'CRAFT', 'CRASH', 'CREAM', 'CRIME', 'CROSS',
  'CROWD', 'CROWN', 'CURVE', 'CYCLE', 'DAILY', 'DANCE', 'DEATH', 'DEPTH', 'DOUBT', 'DRAFT',
  'DRAMA', 'DREAM', 'DRESS', 'DRINK', 'DRIVE', 'EARLY', 'EARTH', 'EMPTY', 'ENEMY', 'ENJOY',
  'ENTER', 'ENTRY', 'EQUAL', 'ERROR', 'EVENT', 'EXACT', 'EXIST', 'EXTRA', 'FAITH', 'FALSE',
  'FATAL', 'FAULT', 'FIBER', 'FIELD', 'FIFTH', 'FIGHT', 'FINAL', 'FOCUS', 'FORCE', 'FRAME',
  'FRANK', 'FRESH', 'FRONT', 'FRUIT', 'FULLY', 'FUNNY', 'GIANT', 'GRACE', 'GRADE', 'GRAND',
  ...
  'MAGIC', 'MAJOR', 'MARCH', 'MATCH', 'METAL', 'MINOR', 'MONEY', 'MONTH', 'MORAL', 'MOTOR',
  'MOUSE', 'MOUTH', 'MOVIE', 'MUSIC', 'NEEDS', 'NOISE', 'NORTH', 'NOVEL', 'NURSE', 'OCCUR',
  'OCEAN', 'OFFER', 'ORDER', 'OTHER', 'OUTER', 'PANEL', 'PAPER', 'PARTY', 'PEACE', 'PHASE',
  ...
  'SHAPE', 'SHARE', 'SHARP', 'SHEEP', 'SHEET', 'SHELF', 'SHELL', 'SHIFT', 'SHIRT', 'SHOCK',
  ...
  'STUDY', 'STYLE', 'SUGAR', 'SWEET', 'TABLE', 'TASTE', 'TEACH', 'TEETH', 'THANK', 'THEFT',
  'THEIR', 'THEME', 'THERE', 'THICK', 'THING', 'THINK', 'THIRD', 'THROW', 'TIGHT', 'TITLE',
  'TODAY', 'TOUCH', 'TOUGH', 'TOWER', 'TRACK', 'TRADE', 'TRAIN', 'TREAT', 'TREND', 'TRIAL',
  'TRIBE', 'TRICK', 'TRIED', 'TRUST', 'TRUTH', 'UNDER', 'UNITE', 'UNITY', 'UPSET', 'URBAN',
  'USAGE', 'USUAL', 'VALID', 'VALUE', 'VIDEO', 'VIRUS', 'VISIT', 'VITAL', 'VOICE', 'WASTE',
  'WATCH', 'WATER', 'WHEEL', 'WHERE', 'WHITE', 'WHOLE', 'WHOSE', 'WOMAN', 'WORLD', 'WORRY',
